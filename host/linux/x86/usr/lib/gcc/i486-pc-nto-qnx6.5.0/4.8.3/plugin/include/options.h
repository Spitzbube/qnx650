...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 1041,            /* -m128bit-long-double */
  OPT_m32 = 1042,                            /* -m32 */
  OPT_m3dnow = 1043,                         /* -m3dnow */
  OPT_m3dnowa = 1044,                        /* -m3dnowa */
  OPT_m64 = 1045,                            /* -m64 */
  OPT_m80387 = 1046,                         /* -m80387 */
  OPT_m8bit_idiv = 1047,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1048,             /* -m96bit-long-double */
  OPT_mabi_ = 1049,                          /* -mabi= */
  OPT_mabm = 1050,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1051,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1052,                 /* -maddress-mode= */
  OPT_madx = 1053,                           /* -madx */
  OPT_maes = 1054,                           /* -maes */
  OPT_malign_double = 1055,                  /* -malign-double */
  OPT_malign_functions_ = 1056,              /* -malign-functions= */
  OPT_malign_jumps_ = 1057,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1058,                  /* -malign-loops= */
  OPT_malign_stringops = 1059,               /* -malign-stringops */
  OPT_march_ = 1060,                         /* -march= */
  OPT_masm_ = 1061,                          /* -masm= */
  OPT_mavx = 1062,                           /* -mavx */
  OPT_mavx2 = 1063,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1064,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1065,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1066,                           /* -mbmi */
  ...
  OPT_pthread = 1180,                        /* -pthread */
  OPT_quiet = 1181,                          /* -quiet */
  OPT_r = 1182,                              /* -r */
  OPT_rdynamic = 1183,                       /* -rdynamic */
  OPT_remap = 1184,                          /* -remap */
  OPT_rpath_link = 1185,                     /* -rpath-link */
  OPT_rpath_link_ = 1186,                    /* -rpath-link= */
  OPT_rpath_ = 1187,                         /* -rpath= */
  OPT_s = 1188,                              /* -s */
  ...
  OPT_std_c__98 = 1208,                      /* -std=c++98 */
  OPT_std_c11 = 1209,                        /* -std=c11 */
  /* OPT_std_c1x = 1210, */                  /* -std=c1x */
  /* OPT_std_c89 = 1211, */                  /* -std=c89 */
  OPT_std_c90 = 1212,                        /* -std=c90 */
  OPT_std_c99 = 1213,                        /* -std=c99 */
  /* OPT_std_c9x = 1214, */                  /* -std=c9x */
  OPT_std_f2003 = 1215,                      /* -std=f2003 */
  OPT_std_f2008 = 1216,                      /* -std=f2008 */
  OPT_std_f2008ts = 1217,                    /* -std=f2008ts */
  OPT_std_f95 = 1218,                        /* -std=f95 */
  OPT_std_gnu = 1219,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1220, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1221, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1222,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1223,                    /* -std=gnu++1y */
