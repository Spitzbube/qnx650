...
enum opt_code
{
  ...
  OPT_mgp32 = 1076,                          /* -mgp32 */
  OPT_mgp64 = 1077,                          /* -mgp64 */
  OPT_mgpopt = 1078,                         /* -mgpopt */
  OPT_mhard_float = 1079,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1080,              /* -minterlink-mips16 */
  OPT_mips = 1081,                           /* -mips */
  OPT_mips16 = 1082,                         /* -mips16 */
  OPT_mips3d = 1083,                         /* -mips3d */
  OPT_mllsc = 1084,                          /* -mllsc */
  OPT_mlocal_sdata = 1085,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1086,                    /* -mlong-calls */
  OPT_mlong32 = 1087,                        /* -mlong32 */
  OPT_mlong64 = 1088,                        /* -mlong64 */
  OPT_mmad = 1089,                           /* -mmad */
  OPT_mmcount_ra_address = 1090,             /* -mmcount-ra-address */
  OPT_mmcu = 1091,                           /* -mmcu */
  OPT_mmemcpy = 1092,                        /* -mmemcpy */
  OPT_mmt = 1093,                            /* -mmt */
  OPT_mno_float = 1094,                      /* -mno-float */
  OPT_mno_flush_func = 1095,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1096,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1097,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1098,                     /* -mno-mips3d */
  OPT_mpaired_single = 1099,                 /* -mpaired-single */
  OPT_mplt = 1100,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1101,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1102,               /* -mrelax-pic-calls */
  OPT_mshared = 1103,                        /* -mshared */
  OPT_msingle_float = 1104,                  /* -msingle-float */
  OPT_msmartmips = 1105,                     /* -msmartmips */
  OPT_msoft_float = 1106,                    /* -msoft-float */
  OPT_msplit_addresses = 1107,               /* -msplit-addresses */
  OPT_msym32 = 1108,                         /* -msym32 */
  OPT_msynci = 1109,                         /* -msynci */
  OPT_mtune_ = 1110,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1111,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1112,                  /* -mvr4130-align */
  OPT_mxgot = 1113,                          /* -mxgot */
  OPT_n = 1114,                              /* -n */
  OPT_no_canonical_prefixes = 1115,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1116,              /* -no-integrated-cpp */
  OPT_noasmopt = 1117,                       /* -noasmopt */
  ...
  OPT_rpath_link = 1149,                     /* -rpath-link */
  OPT_rpath_link_ = 1150,                    /* -rpath-link= */
  OPT_rpath_ = 1151,                         /* -rpath= */
  OPT_s = 1152,                              /* -s */
  ...
  OPT_time = 1203,                           /* -time */
  OPT_time_ = 1204,                          /* -time= */
  OPT_traditional = 1205,                    /* -traditional */
  OPT_traditional_cpp = 1206,                /* -traditional-cpp */
  OPT_trigraphs = 1207,                      /* -trigraphs */
  OPT_u = 1208,                              /* -u */
  OPT_undef = 1209,                          /* -undef */
  OPT_v = 1210,                              /* -v */
  OPT_version = 1211,                        /* -version */
  OPT_w = 1212,                              /* -w */
  OPT_wrapper = 1213,                        /* -wrapper */
  OPT_x = 1214,                              /* -x */
  OPT_z = 1215,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
