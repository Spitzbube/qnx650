...
#define MASK_LITTLE_ENDIAN (1 << 5)
#define MASK_BIGTABLE (1 << 6)
#define MASK_BITOPS (1 << 7)
#define MASK_ALIGN_DOUBLE (1 << 8)
#define MASK_FMOVD (1 << 9)
#define MASK_HITACHI (1 << 10)
#define MASK_ALLOW_INDEXED_ADDRESS (1 << 11)
#define MASK_INVALID_SYMBOLS (1 << 12)
#define MASK_DUMPISIZE (1 << 13)
#define MASK_NOMACSAVE (1 << 14)
#define MASK_PADSTRUCT (1 << 15)
#define MASK_PREFERGOT (1 << 16)
#define MASK_PT_FIXED (1 << 17)
#define MASK_RELAX (1 << 18)
#define MASK_FPU_SINGLE (1 << 19)
#define MASK_FPU_SINGLE_ONLY (1 << 20)
#define MASK_HARD_SH2A (1 << 21)
#define MASK_HARD_SH2A_DOUBLE (1 << 22)
#define MASK_HARD_SH4 (1 << 23)
#define MASK_SAVE_ALL_TARGET_REGS (1 << 24)
#define MASK_SH5 (1 << 25)
#define MASK_SH_E (1 << 26)
...
enum opt_code
{
  ...
  OPT_m2 = 1042,                             /* -m2 */
  OPT_m2a = 1043,                            /* -m2a */
  OPT_m2a_nofpu = 1044,                      /* -m2a-nofpu */
  OPT_m2a_single = 1045,                     /* -m2a-single */
  OPT_m2a_single_only = 1046,                /* -m2a-single-only */
  OPT_m2e = 1047,                            /* -m2e */
  OPT_m3 = 1048,                             /* -m3 */
  OPT_m3e = 1049,                            /* -m3e */
  OPT_m4 = 1050,                             /* -m4 */
  OPT_m4_100 = 1051,                         /* -m4-100 */
  OPT_m4_100_nofpu = 1052,                   /* -m4-100-nofpu */
  OPT_m4_100_single = 1053,                  /* -m4-100-single */
  OPT_m4_100_single_only = 1054,             /* -m4-100-single-only */
  OPT_m4_200 = 1055,                         /* -m4-200 */
  OPT_m4_200_nofpu = 1056,                   /* -m4-200-nofpu */
  OPT_m4_200_single = 1057,                  /* -m4-200-single */
  OPT_m4_200_single_only = 1058,             /* -m4-200-single-only */
  OPT_m4_300 = 1059,                         /* -m4-300 */
  OPT_m4_300_nofpu = 1060,                   /* -m4-300-nofpu */
  OPT_m4_300_single = 1061,                  /* -m4-300-single */
  OPT_m4_300_single_only = 1062,             /* -m4-300-single-only */
  OPT_m4_340 = 1063,                         /* -m4-340 */
  OPT_m4_400 = 1064,                         /* -m4-400 */
  OPT_m4_500 = 1065,                         /* -m4-500 */
  OPT_m4_nofpu = 1066,                       /* -m4-nofpu */
  OPT_m4_single = 1067,                      /* -m4-single */
  OPT_m4_single_only = 1068,                 /* -m4-single-only */
  OPT_m4a = 1069,                            /* -m4a */
  OPT_m4a_nofpu = 1070,                      /* -m4a-nofpu */
  OPT_m4a_single = 1071,                     /* -m4a-single */
  OPT_m4a_single_only = 1072,                /* -m4a-single-only */
  OPT_m4al = 1073,                           /* -m4al */
  OPT_m5_32media = 1074,                     /* -m5-32media */
  OPT_m5_32media_nofpu = 1075,               /* -m5-32media-nofpu */
  OPT_m5_64media = 1076,                     /* -m5-64media */
  OPT_m5_64media_nofpu = 1077,               /* -m5-64media-nofpu */
  OPT_m5_compact = 1078,                     /* -m5-compact */
  OPT_m5_compact_nofpu = 1079,               /* -m5-compact-nofpu */
  OPT_maccumulate_outgoing_args = 1080,      /* -maccumulate-outgoing-args */
  /* OPT_madjust_unroll = 1081, */           /* -madjust-unroll */
  OPT_matomic_model_ = 1082,                 /* -matomic-model= */
  OPT_mb = 1083,                             /* -mb */
  OPT_mbigtable = 1084,                      /* -mbigtable */
  OPT_mbitops = 1085,                        /* -mbitops */
  OPT_mbranch_cost_ = 1086,                  /* -mbranch-cost= */
  OPT_mcbranchdi = 1087,                     /* -mcbranchdi */
  OPT_mcmpeqdi = 1088,                       /* -mcmpeqdi */
  OPT_mcut2_workaround = 1089,               /* -mcut2-workaround */
  OPT_mdalign = 1090,                        /* -mdalign */
  OPT_mdiv_ = 1091,                          /* -mdiv= */
  OPT_mdivsi3_libfunc_ = 1092,               /* -mdivsi3_libfunc= */
  OPT_mfixed_range_ = 1093,                  /* -mfixed-range= */
  OPT_mfmovd = 1094,                         /* -mfmovd */
  OPT_mfsca = 1095,                          /* -mfsca */
  OPT_mfsrra = 1096,                         /* -mfsrra */
  /* OPT_mfused_madd = 1097, */              /* -mfused-madd */
  OPT_mgettrcost_ = 1098,                    /* -mgettrcost= */
  OPT_mhitachi = 1099,                       /* -mhitachi */
  OPT_mieee = 1100,                          /* -mieee */
  OPT_mindexed_addressing = 1101,            /* -mindexed-addressing */
  OPT_minline_ic_invalidate = 1102,          /* -minline-ic_invalidate */
  OPT_minvalid_symbols = 1103,               /* -minvalid-symbols */
  OPT_misize = 1104,                         /* -misize */
  OPT_ml = 1105,                             /* -ml */
  OPT_mnomacsave = 1106,                     /* -mnomacsave */
  OPT_mpadstruct = 1107,                     /* -mpadstruct */
  OPT_mprefergot = 1108,                     /* -mprefergot */
  OPT_mpretend_cmove = 1109,                 /* -mpretend-cmove */
  OPT_mpt_fixed = 1110,                      /* -mpt-fixed */
  OPT_mrelax = 1111,                         /* -mrelax */
  OPT_mrenesas = 1112,                       /* -mrenesas */
  /* OPT_msoft_atomic = 1113, */             /* -msoft-atomic */
  /* OPT_mspace = 1114, */                   /* -mspace */
  OPT_mtas = 1115,                           /* -mtas */
  OPT_multcost_ = 1116,                      /* -multcost= */
  OPT_musermode = 1117,                      /* -musermode */
  OPT_mzdcbranch = 1118,                     /* -mzdcbranch */
  OPT_n = 1119,                              /* -n */
  OPT_no_canonical_prefixes = 1120,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1121,              /* -no-integrated-cpp */
  OPT_nocpp = 1122,                          /* -nocpp */
  OPT_nodefaultlibs = 1123,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1124,                   /* -nostartfiles */
  OPT_nostdinc = 1125,                       /* -nostdinc */
  OPT_nostdinc__ = 1126,                     /* -nostdinc++ */
  OPT_nostdlib = 1127,                       /* -nostdlib */
  OPT_o = 1128,                              /* -o */
  OPT_p = 1129,                              /* -p */
  OPT_pass_exit_codes = 1130,                /* -pass-exit-codes */
  /* OPT_pedantic = 1131, */                 /* -pedantic */
  OPT_pedantic_errors = 1132,                /* -pedantic-errors */
  OPT_pg = 1133,                             /* -pg */
  OPT_pie = 1134,                            /* -pie */
  OPT_pipe = 1135,                           /* -pipe */
  OPT_posix = 1136,                          /* -posix */
  OPT_print_file_name_ = 1137,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1138,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1139,          /* -print-multi-directory */
  OPT_print_multi_lib = 1140,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1141,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1142,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1143,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1144,               /* -print-prog-name= */
  OPT_print_search_dirs = 1145,              /* -print-search-dirs */
  OPT_print_sysroot = 1146,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1147,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1148,                        /* -pthread */
  OPT_quiet = 1149,                          /* -quiet */
  OPT_r = 1150,                              /* -r */
  OPT_rdynamic = 1151,                       /* -rdynamic */
  OPT_remap = 1152,                          /* -remap */
  OPT_rpath_link = 1153,                     /* -rpath-link */
  OPT_rpath_link_ = 1154,                    /* -rpath-link= */
  OPT_rpath_ = 1155,                         /* -rpath= */
  OPT_s = 1156,                              /* -s */
