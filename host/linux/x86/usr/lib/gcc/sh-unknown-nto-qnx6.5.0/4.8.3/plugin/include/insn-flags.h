...
#define HAVE_tsthi_t (TARGET_SH1 \
   && CONST_OK_FOR_K08 (INTVAL (operands[1])))
#define HAVE_tstqi_t (TARGET_SH1 \
   && (CONST_OK_FOR_K08 (INTVAL (operands[1]))  \
       || CONST_OK_FOR_I08 (INTVAL (operands[1]))))
#define HAVE_tstsi_t_and_not (TARGET_SH1)
#define HAVE_tstqi_t_zero_extract_eq (TARGET_SH1 \
   && CONST_OK_FOR_K08 (ZERO_EXTRACT_ANDMASK (operands[1], operands[2])))
#define HAVE_tsthi_t_zero_extract_eq (TARGET_SH1 \
   && CONST_OK_FOR_K08 (ZERO_EXTRACT_ANDMASK (operands[1], operands[2])))
#define HAVE_tstsi_t_zero_extract_eq (TARGET_SH1 \
   && CONST_OK_FOR_K08 (ZERO_EXTRACT_ANDMASK (operands[1], operands[2])))
#define HAVE_tstdi_t_zero_extract_eq (TARGET_SH1 \
   && CONST_OK_FOR_K08 (ZERO_EXTRACT_ANDMASK (operands[1], operands[2])))
#define HAVE_tstsi_t_zero_extract_xor (TARGET_SH1 \
   && ZERO_EXTRACT_ANDMASK (operands[1], operands[2]) == INTVAL (operands[3]) \
   && CONST_OK_FOR_K08 (INTVAL (operands[3])))
#define HAVE_tstsi_t_zero_extract_subreg_xor_little (TARGET_SH1 && TARGET_LITTLE_ENDIAN \
   && ZERO_EXTRACT_ANDMASK (operands[1], operands[2]) \
      == (INTVAL (operands[3]) & 255) \
   && CONST_OK_FOR_K08 (INTVAL (operands[3]) & 255))
#define HAVE_tstsi_t_zero_extract_subreg_xor_big (TARGET_SH1 && ! TARGET_LITTLE_ENDIAN \
   && ZERO_EXTRACT_ANDMASK (operands[1], operands[2]) \
      == (INTVAL (operands[3]) & 255) \
   && CONST_OK_FOR_K08 (INTVAL (operands[3]) & 255))
...
#define HAVE_cmp_div0s_0 (TARGET_SH1)
#define HAVE_cmp_div0s_1 (TARGET_SH1)
...
#define HAVE_movrt_xor (TARGET_SH1 && !TARGET_SH2A)
#define HAVE_mov_neg_si_t (TARGET_SH1)
#define HAVE_nott (TARGET_SH1)
...
#define HAVE_toggle_pr (TARGET_SH4A_FP && ! TARGET_FPU_SINGLE)
...
#define HAVE_bld_reg (TARGET_SH2A && satisfies_constraint_K03 (operands[1]))
...
#define HAVE_atomic_compare_and_swapqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_compare_and_swaphi_hard (TARGET_ATOMIC_HARD_LLCS)
...
#define HAVE_atomic_exchangesi_hard (TARGET_ATOMIC_HARD_LLCS \
   || (TARGET_SH4A_ARCH && TARGET_ATOMIC_ANY && !TARGET_ATOMIC_STRICT))
#define HAVE_atomic_exchangeqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_exchangehi_hard (TARGET_ATOMIC_HARD_LLCS)
...
#define HAVE_atomic_fetch_andsi_hard (TARGET_ATOMIC_HARD_LLCS \
   || (TARGET_SH4A_ARCH && TARGET_ATOMIC_ANY && !TARGET_ATOMIC_STRICT))
#define HAVE_atomic_fetch_addqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_subqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_orqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_xorqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_andqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_addhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_subhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_orhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_xorhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_andhi_hard (TARGET_ATOMIC_HARD_LLCS)
...
#define HAVE_atomic_fetch_nandsi_hard (TARGET_ATOMIC_HARD_LLCS \
   || (TARGET_SH4A_ARCH && TARGET_ATOMIC_ANY && !TARGET_ATOMIC_STRICT))
#define HAVE_atomic_fetch_nandqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_fetch_nandhi_hard (TARGET_ATOMIC_HARD_LLCS)
...
#define HAVE_atomic_and_fetchsi_hard (TARGET_ATOMIC_HARD_LLCS \
   || (TARGET_SH4A_ARCH && TARGET_ATOMIC_ANY && !TARGET_ATOMIC_STRICT))
#define HAVE_atomic_add_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_sub_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_or_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_xor_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_and_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_add_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_sub_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_or_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_xor_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_and_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
...
#define HAVE_atomic_nand_fetchsi_hard (TARGET_ATOMIC_HARD_LLCS \
   || (TARGET_SH4A_ARCH && TARGET_ATOMIC_ANY && !TARGET_ATOMIC_STRICT))
#define HAVE_atomic_nand_fetchqi_hard (TARGET_ATOMIC_HARD_LLCS)
#define HAVE_atomic_nand_fetchhi_hard (TARGET_ATOMIC_HARD_LLCS)
