...
#define HAVE_unpacktf_0 1
#define HAVE_unpacktf_1 1
...
static inline rtx gen_htm_mfspr_di                (rtx, rtx, rtx);
static inline rtx
gen_htm_mfspr_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
extern rtx        gen_htm_mtspr_si                (rtx, rtx, rtx);
static inline rtx gen_htm_mtspr_di                (rtx, rtx, rtx);
static inline rtx
gen_htm_mtspr_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_unpacktf_0                  (rtx, rtx);
extern rtx        gen_unpacktf_1                  (rtx, rtx);
