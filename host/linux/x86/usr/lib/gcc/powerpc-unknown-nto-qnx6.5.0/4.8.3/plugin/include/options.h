...
#ifndef GENERATOR_FILE
  int x_VAR_me500v1;
#define x_VAR_me500v1 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_me500v2;
#define x_VAR_me500v2 do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_memb;
...
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1 << 31)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1 << 32)
#define OPTION_MASK_UPPER_REGS_DF (HOST_WIDE_INT_1 << 33)
#define OPTION_MASK_UPPER_REGS_SF (HOST_WIDE_INT_1 << 34)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1 << 35)
#define OPTION_MASK_VSX_TIMODE (HOST_WIDE_INT_1 << 36)
 #if defined(HOST_BITS_PER_WIDE_INT) && 37 >= HOST_BITS_PER_WIDE_INT
...
#define TARGET_FP_MOVES ((target_flags & MASK_FP_MOVES) != 0)
...
enum opt_code
{
  ...
  OPT_ffixed_ = 596,                         /* -ffixed- */
  OPT_ffixed_form = 597,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 598,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 599,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 600,                    /* -ffloat-store */
  OPT_ffor_scope = 601,                      /* -ffor-scope */
  /* OPT_fforce_addr = 602, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 603,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 604,              /* -fforward-propagate */
  OPT_ffp_contract_ = 605,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 606,                      /* -ffpe-trap= */
  OPT_ffree_form = 607,                      /* -ffree-form */
  OPT_ffree_line_length_ = 608,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 609,          /* -ffree-line-length-none */
  OPT_ffreestanding = 610,                   /* -ffreestanding */
  OPT_ffriend_injection = 611,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 612,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 613,                   /* -ffunction-cse */
  OPT_ffunction_sections = 614,              /* -ffunction-sections */
  OPT_fgcse = 615,                           /* -fgcse */
  OPT_fgcse_after_reload = 616,              /* -fgcse-after-reload */
  OPT_fgcse_las = 617,                       /* -fgcse-las */
  OPT_fgcse_lm = 618,                        /* -fgcse-lm */
  OPT_fgcse_sm = 619,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 620,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 621,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 622,                         /* -fgnu-tm */
  ...
  OPT_m32 = 1042,                            /* -m32 */
  OPT_m64 = 1043,                            /* -m64 */
  OPT_mabi_altivec = 1044,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1045,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1046,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1047,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1048,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1049,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1050,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1051,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1052,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1053,                       /* -mabi=spe */
  OPT_mads = 1054,                           /* -mads */
  OPT_maix_struct_return = 1055,             /* -maix-struct-return */
  OPT_malign_ = 1056,                        /* -malign- */
  OPT_malign_branch_targets = 1057,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1058,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1059,             /* -mallow-movmisalign */
  OPT_maltivec = 1060,                       /* -maltivec */
  OPT_maltivec_be = 1061,                    /* -maltivec=be */
  OPT_maltivec_le = 1062,                    /* -maltivec=le */
  OPT_malways_hint = 1063,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1064,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1065,                           /* -mbig */
  OPT_mbig_endian = 1066,                    /* -mbig-endian */
  OPT_mbit_align = 1067,                     /* -mbit-align */
  OPT_mbit_word = 1068,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1069,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1070,                       /* -mbss-plt */
  OPT_mcall_ = 1071,                         /* -mcall- */
  ...
  OPT_me500v1 = 1080,                        /* -me500v1 */
  OPT_me500v2 = 1081,                        /* -me500v2 */
  OPT_meabi = 1082,                          /* -meabi */
  OPT_memb = 1083,                           /* -memb */
  OPT_mfloat_gprs_ = 1084,                   /* -mfloat-gprs= */
  OPT_mfp_in_toc = 1085,                     /* -mfp-in-toc */
  OPT_mfp_moves = 1086,                      /* -mfp-moves */
  OPT_mfprnd = 1087,                         /* -mfprnd */
  OPT_mfpu_ = 1088,                          /* -mfpu= */
  OPT_mfriz = 1089,                          /* -mfriz */
  OPT_mfull_toc = 1090,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1091, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1092,            /* -mgen-cell-microcode */
  OPT_mhard_dfp = 1093,                      /* -mhard-dfp */
  OPT_mhard_float = 1094,                    /* -mhard-float */
  OPT_mhtm = 1095,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1096,            /* -minsert-sched-nops= */
  OPT_misel = 1097,                          /* -misel */
  /* OPT_misel_no = 1098, */                 /* -misel=no */
  /* OPT_misel_yes = 1099, */                /* -misel=yes */
  OPT_mlittle = 1100,                        /* -mlittle */
  OPT_mlittle_endian = 1101,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1102,                  /* -mlong-double- */
  OPT_mlongcall = 1103,                      /* -mlongcall */
  OPT_mlra = 1104,                           /* -mlra */
  OPT_mmfcrf = 1105,                         /* -mmfcrf */
  OPT_mmfpgpr = 1106,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1107,                   /* -mminimal-toc */
  OPT_mmulhw = 1108,                         /* -mmulhw */
  OPT_mmultiple = 1109,                      /* -mmultiple */
  ...
  OPT_mpaired = 1117,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1118,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1119,                       /* -mpopcntb */
  OPT_mpopcntd = 1120,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1121,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1122,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1123,                 /* -mpower8-vector */
  /* OPT_mpowerpc = 1124, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1125,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1126,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1127,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1128,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1129,                     /* -mprototype */
  OPT_mquad_memory = 1130,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1131,            /* -mquad-memory-atomic */
  OPT_mrecip = 1132,                         /* -mrecip */
  OPT_mrecip_precision = 1133,               /* -mrecip-precision */
  OPT_mrecip_ = 1134,                        /* -mrecip= */
  OPT_mregnames = 1135,                      /* -mregnames */
  OPT_mrelocatable = 1136,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1137,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1138,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1139,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1140,                  /* -msched-epilog */
  OPT_msched_groups = 1141,                  /* -msched-groups */
  OPT_msched_prolog = 1142,                  /* -msched-prolog */
  OPT_msdata = 1143,                         /* -msdata */
  OPT_msdata_ = 1144,                        /* -msdata= */
  OPT_msecure_plt = 1145,                    /* -msecure-plt */
  OPT_mshlib = 1146,                         /* -mshlib */
  OPT_msim = 1147,                           /* -msim */
  OPT_msimple_fpu = 1148,                    /* -msimple-fpu */
  OPT_msingle_float = 1149,                  /* -msingle-float */
  OPT_msingle_pic_base = 1150,               /* -msingle-pic-base */
  OPT_msoft_float = 1151,                    /* -msoft-float */
  OPT_mspe = 1152,                           /* -mspe */
  /* OPT_mspe_no = 1153, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1154, */                 /* -mspe=yes */
  OPT_mstrict_align = 1155,                  /* -mstrict-align */
  OPT_mstring = 1156,                        /* -mstring */
  OPT_msum_in_toc = 1157,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1158,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1159,                   /* -mtls-markers */
  OPT_mtls_size_ = 1160,                     /* -mtls-size= */
  OPT_mtoc = 1161,                           /* -mtoc */
  OPT_mtraceback_ = 1162,                    /* -mtraceback= */
  OPT_mtune_ = 1163,                         /* -mtune= */
  OPT_mupdate = 1164,                        /* -mupdate */
  OPT_mupper_regs_df = 1165,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1166,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1167,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1168,            /* -mvectorize-builtins */
  OPT_mvrsave = 1169,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1170, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1171, */              /* -mvrsave=yes */
  OPT_mvsx = 1172,                           /* -mvsx */
  OPT_mvsx_align_128 = 1173,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1174,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1175,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1176, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1177,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1178,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1179,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1180,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1181,                     /* -mxl-compat */
  OPT_myellowknife = 1182,                   /* -myellowknife */
  OPT_n = 1183,                              /* -n */
  ...
  OPT_pthread = 1212,                        /* -pthread */
  OPT_quiet = 1213,                          /* -quiet */
  OPT_r = 1214,                              /* -r */
  OPT_rdynamic = 1215,                       /* -rdynamic */
  OPT_remap = 1216,                          /* -remap */
  OPT_rpath_link = 1217,                     /* -rpath-link */
  OPT_rpath_link_ = 1218,                    /* -rpath-link= */
  OPT_rpath_ = 1219,                         /* -rpath= */
  OPT_s = 1220,                              /* -s */
  OPT_s_bc_abi = 1221,                       /* -s-bc-abi */
  OPT_save_temps = 1222,                     /* -save-temps */
  OPT_save_temps_ = 1223,                    /* -save-temps= */
  OPT_shared = 1224,                         /* -shared */
  OPT_shared_libgcc = 1225,                  /* -shared-libgcc */
  /* OPT_specs = 1226, */                    /* -specs */
  OPT_specs_ = 1227,                         /* -specs= */
  OPT_static = 1228,                         /* -static */
  OPT_static_libasan = 1229,                 /* -static-libasan */
  OPT_static_libgcc = 1230,                  /* -static-libgcc */
  OPT_static_libgcj = 1231,                  /* -static-libgcj */
  ...
  /* OPT_std_c__03 = 1236, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1237, */                /* -std=c++0x */
  OPT_std_c__11 = 1238,                      /* -std=c++11 */
  OPT_std_c__1y = 1239,                      /* -std=c++1y */
  OPT_std_c__98 = 1240,                      /* -std=c++98 */
  OPT_std_c11 = 1241,                        /* -std=c11 */
  /* OPT_std_c1x = 1242, */                  /* -std=c1x */
  /* OPT_std_c89 = 1243, */                  /* -std=c89 */
  OPT_std_c90 = 1244,                        /* -std=c90 */
  OPT_std_c99 = 1245,                        /* -std=c99 */
  /* OPT_std_c9x = 1246, */                  /* -std=c9x */
  OPT_std_f2003 = 1247,                      /* -std=f2003 */
  OPT_std_f2008 = 1248,                      /* -std=f2008 */
  OPT_std_f2008ts = 1249,                    /* -std=f2008ts */
  OPT_std_f95 = 1250,                        /* -std=f95 */
  OPT_std_gnu = 1251,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1252, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1253, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1254,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1255,                    /* -std=gnu++1y */
